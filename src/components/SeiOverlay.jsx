...
export function SeiOverlay({ seiData, isLoading, error, currentAngle, speedUnit = 'mph', onSpeedUnitToggle, onDebugClick, isHighPrecision = false }) {
  ...
  return (
    <>
      <div className="sei-overlay">
        {/* High Precision Indicator - Always visible */}
        <div 
        ...
        {/* SEI Debug Button */}
        <button 
          className="sei-debug-button"
          onClick={onDebugClick}
          title="Show Raw SEI Data (D)"
        >
          SEI Debug
        </button>
      ...
      {/* Precision Modal - Rendered outside sei-overlay to avoid pointer-events issues */}
      {showPrecisionModal && (
